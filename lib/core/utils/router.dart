...
import 'package:running_app/features/auth/presentation/views/log_in_view.dart';
import 'package:running_app/features/auth/presentation/views/sign_up_view.dart';
...
abstract class AppRouter {
  ...
  static final router = GoRouter(
    routes: <RouteBase>[
      ...
      GoRoute(
        path: ksignupView,
        builder: (context, state) => SiginUpView(),
      ),
    ],
  );
}
